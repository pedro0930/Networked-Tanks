...
public class GameManager : NetworkBehaviour
{
    ...
    public float m_LoadDelay = 3f;              // The delay between the start of RoundPerSet and RoundStarting phases.
    ...
    private IEnumerator RoundPerSet()
    {
        ...
        for (var i = 0; i < playerTanks.Length; i++)
        {
            ...
            var sp = spawnPoints[i].GetComponent<Transform>();
            m_Tanks[i].RpcSpawnPoint(sp.localPosition, sp.localRotation);
        }
    }
    ...
    private IEnumerator RoundStarting ()
    {
        ...
        m_RoundNumber++;        
        RpcSetMessage("ROUND " + m_RoundNumber);
    ...
    private void DisableTankControl()
    {
        for (int i = 0; i < m_Tanks.Length; i++)
        {
            m_Tanks[i].RpcDisableControl();
        }
    }

    [ClientRpc]
    public void RpcSetMessage(string msg) {
